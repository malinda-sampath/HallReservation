                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div>
                                            ...
                                            <input type="date" class="form-control" id="event-date" name= "event-date" placeholder="event-date">
                                        </div><p>
                                        <div>
                                            <label for="start-time">Start Time</label>
                                            <input type="time" class="form-control" id="start-time" name="start-time" placeholder="start-time">
                                        </div>
                                        <div>
                                            <label for="end-time">End Time</label>
                                            <input type="time" class="form-control" id="end-time" name="end-time" placeholder="end-time">
                                        </div>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div>
                                            <input type="text" class="form-control" id="contact-num" name="contact-num" placeholder="Your Contact Number">
                                        </div>

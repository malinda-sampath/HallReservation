    ...
    <div class="container-xxl bg-white p-0">
        ...
        <div class="container-fluid nav-bar bg-transparent">
            <nav class="navbar navbar-expand-lg bg-white navbar-light py-0 px-4">
                <a href="<?php echo e(route('index')); ?>" class="navbar-brand d-flex align-items-center text-center">
...
</html><?php /**PATH D:\Github\Web\Hall Reservation - Copy Latest\hall_reservation\hall_revervation\resources\views/index.blade.php ENDPATH**/ ?>
    ...
    <div class="container-xxl bg-white p-0">
        ...
        <div class="container-fluid nav-bar bg-transparent">
            <nav class="navbar navbar-expand-lg bg-white navbar-light py-0 px-4">
                <a href="<?php echo e(url('/index')); ?>" class="navbar-brand d-flex align-items-center text-center">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto">
                        <a href="<?php echo e(url('/index')); ?>" class="nav-item nav-link">Home</a>
                    </div>
...
</html><?php /**PATH D:\Github\Web\Hall Reservation - Copy Latest\hall_reservation\hall_revervation\resources\views/contact.blade.php ENDPATH**/ ?>